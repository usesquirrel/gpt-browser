            ...
            <div className="w-full h-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col p-4">
              ...
              <div className="w-full max-w-2xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    onClick={() =>
                      handleNavigate("https://github.com/usesquirrel/gpt-browser")
                    }
                    className="group relative bg-white rounded-xl p-3 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-400 hover:scale-102 active:scale-95"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-300 flex-shrink-0">
                        <svg
